...
1. **Rights Assignment**: The contributor assigns all intellectual property rights for the contribution to **AITDL / Jawahar R Mallah**.
2. **Governance Compliance**: All contributions must strictly follow the NishadRaj OS Governance Protocol.
3. **Execution Gate**: No contribution shall be merged via direct commit. All changes must pass the validator and digital signature layers.
